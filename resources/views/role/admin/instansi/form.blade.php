            ...
            <div class="col-md-12">
                ...
                <form action="{{ url('/admin/instansi/'.$instansi->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="pimpinan" value="{{$instansi->pimpinan}}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="telepon" value="{{$instansi->telepon}}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="profile" rows="2" class="summernote"
                                required>{{$instansi->profile}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="visi_misi" class="col-sm-2 col-form-label">Visi Misi</label>
                        <div class="col-sm-10">
                            <textarea name="visi_misi" rows="2" class="summernote"
                                required>{{$instansi->visi_misi}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
